...
- JavaScript puro em arquivo externo
- Imagens proprias na pasta `assets`
...
As imagens do projeto ficam na pasta `assets`, incluindo logo, ilustracao principal e imagem dos integrantes.
...
Use a pagina `contato.html` para simular o envio de mensagens para a equipe.
